...
<!-- Content Wrapper. Contains page content -->
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">View Course List</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <div  class="form-row">
                  ...
                  <div class="form-group">
                   ...
                   <button class="btn btn-primary btn-sm mb-1" onclick="location.href='<?= base_url('Course/add_course') ?>'"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;Add</button>
  ...
  <input type="hidden" id="display_url" value="Course/display_course">
  <input type="hidden" id="delete_url" value="Course/delete_course">
  <input type="hidden" id="status_url" value="Course/course_status_update">
