...
<!-- Content Wrapper. Contains page content -->
         ...
         <!--  <div class="col-sm-6">
          ...
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">View Institute details</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">View Institute List</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <div  class="form-row">
                  ...
                  <div class="form-group">
                   ...
                   <button class="btn btn-primary btn-sm mb-1" onclick="location.href='<?= base_url('Institute/add_institute') ?>'"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;Add</button>
  ...
  <input type="hidden" id="display_url" value="Institute/display_institute">
  <input type="hidden" id="delete_url" value="Institute/delete_institute">
  <input type="hidden" id="status_url" value="Institute/institute_status_update">
